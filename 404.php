        ...
        <div id="content-wrapper">
            <div class="page-header">
                ...
                <div class="row">
                    ...
                    <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-exclamation-triangle page-header-icon"></i>&nbsp;&nbsp;Error 404</h1>
                </div>
				
				<p style="margin-top: 5px;">
					La URL solicitada <code><?php echo $_SERVER['REQUEST_URI'] ?></code> no existe.
				</p>
            </div> <!-- / .page-header -->
        </div> <!-- / #content-wrapper -->
